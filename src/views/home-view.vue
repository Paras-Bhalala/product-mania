<template>
  ...
  <section class="py-10 container mx-auto px-6">
    ...
    <button
      class="btn btn-primary cursor-pointer border text-center rounded p-1.5"
      @click="goToProducts()"
    >
      See all products
    </button>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
      <div
        ...
        :key="product.id"
        class="border bg-white rounded-lg shadow-md p-2 hover:shadow-lg transition-all duration-300"
      >
        <img
